/*
 * ADM5120 SOC USB Host Controller Interface driver for USB.
 *
 * (C) Copyright 2006
 * SATO, Masuhiro <thomas@fenix.ne.jp>
 *
 * This code is based on linux driver for adm5120 USB HOST controler.
 *
